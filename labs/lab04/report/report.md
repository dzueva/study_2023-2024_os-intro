...
![Команда ls -F](image/img2_5.png){#fig:006 width=70%}
...
![Команда ls -alF](image/img2_6.png){#fig:007 width=70%}
...
![Команда ls /var/spool/ | grep cron](image/img2_7.png){#fig:008 width=70%}
...
![Создание трех директорий одной командой](image/img3_3.png){#fig:012 width=70%}

А теперь удалим все созданные только что директории:
![Удаление трех директорий одной командой](image/img3_4.png){#fig:013 width=70%}
...
![Удаление не пустого каталога](image/img3_5.png){#fig:014 width=70%}
...
![Опция recursive из man ls](image/img4_1.png){#fig:015 width=70%}
...
![Сортировка вывода ls по времени последнего изменения](image/img5_1.png){#fig:016 width=70%}

## 6. Просмотр описания следующих команд: `cd`, `pwd`, `mkdir`, `rmdir`, `rm`. Основные опции этих команд.
Для команды `cd` основной опцией является перемещение в указанную директорию, которая передается в качестве аргумента
![Команда cd](image/img6_1.png){#fig:017 width=70%}

Для `pwd` основная опция -- просмотр полного пути к папке, из которой пишется команда
![Команда pwd](image/img6_2.png){#fig:018 width=70%}

Для `mkdir` основная опция -- создание нового каталога
![Команда mkdir](image/img6_3.png){#fig:019 width=70%}

Для `rmdir` основная опция -- удаление пустого каталога
![Команда rmdir](image/img6_4.png){#fig:020 width=70%}

Для `rm` основная опция -- удаление файлов или пустого каталога. Для удаления каталога с файлами нужна опция `-r`
![Команда rm](image/img6_5.png){#fig:021 width=70%}

## 7. Используя информацию, полученную при помощи команды `history`, выполнение модификаций и исполнения нескольких команд из буфера команд.
![Вывод команды history](image/img7_1.png){#fig:022 width=70%}

![Модификация и исполнение команд из буфера команд](image/img7_2.png){#fig:023 width=70%}
...
![Создание и удаление файла и каталога](image/img8_4.png){#fig:027 width=70%}
...
![Вывод команды history](image/img8_5.png){#fig:028 width=70%}

### 7. Как воспользоваться историей команд для их модифицированного выполнения? Приведите примеры.
Для модифицированного выполнения команд из истории используется подстановка в истории команд
![Модификация и исполнение команд из буфера команд](image/img8_6.png){#fig:029 width=70%}
...
![Подробная информация о файлах и каталогах](image/img8_7.png){#fig:030 width=70%}
