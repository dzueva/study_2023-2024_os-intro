...
![Копирование файлов и каталогов. Копирование нескольких файлов в каталог](image/img1_2.png){#fig:002 width=70%}
![Копирование файлов и каталогов. Копирование файлов в произвольном каталоге](image/img1_3.png){#fig:003 width=70%}
![Копирование файлов и каталогов. Копирование каталогов в текущем каталоге](image/img1_4.png){#fig:004 width=70%}
![Копирование файлов и каталогов. Копирование каталогов в произвольном каталоге](image/img1_5.png){#fig:005 width=70%}

![Перемещение и переименование файлов и каталогов. Переименование файлов в текущем каталоге](image/img1_6.png){#fig:006 width=70%}
![Перемещение и переименование файлов и каталогов. Перемещение файлов в другой каталог](image/img1_7.png){#fig:007 width=70%}
![Перемещение и переименование файлов и каталогов. Переименование каталогов в текущем каталоге](image/img1_8.png){#fig:008 width=70%}
![Перемещение и переименование файлов и каталогов. Перемещение каталога в другой каталог](image/img1_9.png){#fig:009 width=70%}
![Перемещение и переименование файлов и каталогов. Переименование каталога, не являющегося текущим](image/img1_10.png){#fig:010 width=70%}

![Изменение прав доступа. Создание файла с правом выполнения для владельца](image/img1_11.png){#fig:011 width=70%}
![Изменение прав доступа. Лишение владельца файла права на выполнение](image/img1_12.png){#fig:012 width=70%}
![Изменение прав доступа. Создание каталога с запретом на чтение для членов группы и всех остальных пользователей](image/img1_13.png){#fig:013 width=70%}
![Изменение прав доступа. Создание файла с правом записи для членов группы](image/img1_14.png){#fig:014 width=70%}

![Анализ файловой системы. Просмотр используемых в операционной системе файловых систем](image/img1_15.png){#fig:015 width=70%}
![Анализ файловой системы. Просмотр файла/etc/fstab](image/img1_16.png){#fig:016 width=70%}
![Анализ файловой системы. Список всех файловых систем в соответствии с именами устройств, с указанием размера и точки монтирования](image/img1_17.png){#fig:017 width=70%}
![Анализ файловой системы. Проверка целостности файловой системы](image/img1_18.png){#fig:018 width=70%}
...
```
![Копирование файла io.h](image/img2_1.png){#fig:019 width=70%}

В домашнем каталоге создадим директорию `ski.plases`:
![Создание нужной директории](image/img2_2.png){#fig:020 width=70%}

Переместим скопированный файл `equipment` в созданный каталог:
![Перемещение файла в директорию](image/img2_3.png){#fig:021 width=70%}

Переименуем файл `ski.plases/equipment` в `ski.plases/equiplist`:
![Переименование файла](image/img2_4.png){#fig:022 width=70%}
...
![Копирование файла в каталог](image/img2_5.png){#fig:023 width=70%}

Создадим каталог с именем `equipment` в каталоге `ski.plases`:
![Создание подкаталога](image/img2_6.png){#fig:024 width=70%}

Переместим файлы `ski.plases/equiplist` и `equiplist2` в каталог `ski.plases/equipment`:
![Перемещение нескольких файлов](image/img2_7.png){#fig:025 width=70%}

Создадим и переместим каталог `newdir` в каталог `ski.plases` и назовем его `plans`:
![Создание и перемещение директории](image/img2_8.png){#fig:026 width=70%}
...
- `drwxr–r–…` australia
![Изменение прав у файла australia](image/img3_1.png){#fig:027 width=70%}

- `drwx–x–x…` play
![Изменение прав у файла play](image/img3_2.png){#fig:028 width=70%}

- `-r-xr–r–…` my_os
![Изменение прав у файла my_os](image/img3_3.png){#fig:029 width=70%}

- `-rw-rw-r–…` feathers
![Изменение прав у файла feathers](image/img3_4.png){#fig:030 width=70%}
...
![Содержимое /etc/passwd](image/img4_1.png){#fig:031 width=70%}

Скопируем файл `feathers` в файл `file.old`:
![Копирование файла feathers](image/img4_2.png){#fig:032 width=70%}

Переместим файл `file.old` в каталог `play`:
![Перемещение файла file.old](image/img4_3.png){#fig:033 width=70%}

Скопируем каталог `play` в каталог `fun`:
![Копирование play в fun](image/img4_4.png){#fig:034 width=70%}

Переместим каталог `fun` в каталог `play` и назовем его `games`:
![Перемещение и переименование каталога fun](image/img4_5.png){#fig:035 width=70%}

Лишим владельца файла `feathers` права на чтение:
![Лишение владельца прав на чтение](image/img4_6.png){#fig:036 width=70%}

Попытаемся просмотреть файл `feathers` командой `cat`. Получаем ошибку.
![Просмотр файла с отсутствием прав на чтение](image/img4_7.png){#fig:037 width=70%}

Попытаемся скопировать файл `feathers`. Получаем ошибку, так как у нас отсутствуют права на содержимое файла:
![Копирование файла с отсутствием прав на чтение](image/img4_8.png){#fig:038 width=70%}

Дадим владельцу файла `feathers` право на чтение:
![Предоставление владельцу прав доступа](image/img4_9.png){#fig:039 width=70%}

Лишим владельца каталога `play` права на выполнение:
![Лишение владельца права на выполнение](image/img4_10.png){#fig:040 width=70%}

Попробуем перейти в каталог `play`. Получаем ошибку:
![Переход в каталог без прав выполнения](image/img4_11.png){#fig:041 width=70%}

Дадим владельцу каталога `play` обратно права на выполнение:
![Передача прав на выполнение](image/img4_12.png){#fig:042 width=70%}

## 5. Команда man по командам `mount`, `fsck`, `mkfs`, `kill` и кратко их охарактеризуйте, приведя примеры
Для того чтобы узнать характеристики команд используем `man`:
![Команды man](image/img5_1.png){#fig:043 width=70%}
...
![Файловые системы на Fedora](image/img6_1.png){#fig:044 width=70%}
